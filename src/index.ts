...
export const reviewItemDialog = getSyncLifecycle(reviewItemDialogComponent, options);
...
export const approvedComponent = getSyncLifecycle(approvedTabComponent, options);

export const rejectedComponent = getSyncLifecycle(rejectedTabComponent, options);

export const referredTestComponent = getSyncLifecycle(referredTestTabComponent, options);
